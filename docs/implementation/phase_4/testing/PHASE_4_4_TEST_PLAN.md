...
**Testing philosophy:** Unit tests lock handler and utility behavior; integration tests (separate plan) validate against deployed stack; E2E (script-based) validates the full execution path and is documented in [PHASE_4_5_E2E_TEST_PLAN.md](PHASE_4_5_E2E_TEST_PLAN.md) (4.5A).
